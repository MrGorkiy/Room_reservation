...
async def get_all_reservations(
        session: AsyncSession = Depends(get_async_session)):
    """Получение всех переговорок, только для суперюзеров."""
...
async def delete_reservation(
    ...
    """Удаление брони, для суперюзеров или создателей объекта бронирования."""
...
async def update_reservation(
    ...
    """Редактирование брони, для суперюзеров или создателей объекта бронирования."""
